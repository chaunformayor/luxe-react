...
const traditionalPlans = [
  {
    ...
    price: "$99",
    period: "/month",
    name: "Self-Manage with Support",
    desc: "$499 one-time placement fee + $99/month. Professional infrastructure for hands-on owners.",
    features: [
      ...
      "Lease renewal reminders & document storage",
    ],
    featured: false,
    cta: "Get Started",
  },
